...
% xlabel('$\left < \pi^{n}_{sg}\right >(z)/\left < \epsilon \right >$','Interpreter','Latex');
ylabel('$\left < \pi^{n}_{sg}(z)\right >/(u_*^3\Delta z^{-1}\kappa^{-1})$','Interpreter','Latex');
% xlabel('$\left < \pi^{n}_{sg}\right >(z)/\left < \left < u_iu_j \right > \frac{\partial U_i}{\partial x_j}\right >$','Interpreter','Latex');
%xlabel('$\left < \pi^{n}_{sg}\right >(z)/\left < \epsilon \right >$','Interpreter','Latex');
...
'XMinorTick',   'on',...
'LineWidth',    0.5);
SPR = sprintf('%s%s','','pi_chnl_diff_n_by_u3_dz.eps');  
set(gcf, 'Color', 'w');
print(formatEng,SPR);
...
'XMinorTick',   'on',...
'LineWidth',    0.5);
SPR = sprintf('%s%s','','pi_chnl_diff_n_by_u3_dz_2.eps');  
set(gcf, 'Color', 'w');
print(formatEng,SPR);
...
SPR = sprintf('%s%s','','pi_chnl_fixed_h_by_u3_dz.eps');  
set(gcf, 'Color', 'w');
print(formatEng,SPR);
