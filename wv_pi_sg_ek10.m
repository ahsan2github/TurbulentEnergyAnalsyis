...
for ff = 1:length(frameVec)
    ...
    fn = [sfl '/ek10_tau12_'  frameStr   '.bin'];
    fh = fopen(fn, 'r');
    ...
    fn = [sfl '/ek10_tau23_'  frameStr   '.bin'];
    fh = fopen(fn, 'r');
    ...
    disp(['Calculated frame : ' num2str(frameVec(ff))]);
		save('wav_pi_tmn_ek10.mat', 'pi_energy', 'pi_energy2','frame_energy_pi','frame_energy_pi2','-v7.3');
    disp(['=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=']);
    disp([' ']);
end
save('wav_pi_tmn_ek10.mat', 'pi_energy','pi_energy2','frame_energy_pi','frame_energy_pi2','-v7.3');
